...
public class TestHashMapExtra {
    ...
    *  when the node has only 1 or 0 children on either side. */
    ...
    public void testRemoveRootEdge() {
        MyHashMap rightChild = new MyHashMap();
        rightChild.put('A', 1);
        rightChild.put('B', 2);
        ...
        MyHashMap noChild = new MyHashMap();
        noChild.put('Z', 15);
    ...
    public void printInfoInteger(MyHashMap<String, Integer> map) {
        for (Object s : map) {
            System.out.print(s + " ");
        }
    ...
    public void printInfoString(MyHashMap<String, String> map) {
        for (Object s : map) {
            System.out.print(s + " ");
        }
        System.out.println(map.size());
    ...
    public static void main(String[] args) {
        jh61b.junit.TestRunner.runTests(TestHashMapExtra.class);
    }
}
